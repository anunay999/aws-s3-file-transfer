...
public class XferMgrProgress {
    private static final Logger logger = LoggerFactory.getLogger(XferMgrProgress.class);
    ...
    public static void showTransferProgress(Transfer xfer) {
        ...
        // total time elapsed
        logger.info(String.format("Total time elapsed: %s sec.",Duration.between(start, Instant.now()).getSeconds()));
    ...
    public static void showMultiUploadProgress(MultipleFileUpload multi_upload) {
        // print the uploads human-readable description
